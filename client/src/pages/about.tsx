        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8 -my-8">
            <div className="w-full md:w-1/2 text-center md:text-left text-white">
              <h2 className="sm:text-3xl font-bold sm:mb-6 text-[50px] pt-[0px] pb-[0px] mt-[10px] mb-[10px] leading-relaxed">
            ...
            <div className="w-full md:w-1/2 text-center">
              <div className="mx-auto flex items-center justify-center">
                <img src="/imagem/fimagem3.svg" alt="Ilustração DissertAI" className="w-80 h-80 sm:w-96 sm:h-96 md:w-[28rem] md:h-[28rem] lg:w-[32rem] lg:h-[32rem] -my-0" />
              </div>
            </div>
          </div>
        </div>
