...
export default function Features() {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-3 sm:px-6 pt-4 sm:pt-12 pb-4 sm:pb-12">
        ...
        <div className="text-center mb-6 sm:mb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-8">
            <LiquidGlassCard className="p-4 sm:p-8" data-testid="card-statistics">
              <h3 className="text-base sm:text-xl font-semibold text-dark-blue mb-2 sm:mb-4">Estatísticas Alarmantes</h3>
              <div className="text-2xl sm:text-4xl text-red-500 mb-2 sm:mb-4">73%</div>
              <p className="text-sm sm:text-base text-soft-gray">dos estudantes brasileiros têm dificuldade com redação no ENEM</p>
            </LiquidGlassCard>
            <LiquidGlassCard className="p-4 sm:p-8" data-testid="card-challenges">
              <h3 className="text-base sm:text-xl font-semibold text-dark-blue mb-2 sm:mb-4">Principais Desafios</h3>
              <div className="text-2xl sm:text-4xl text-yellow-500 mb-2 sm:mb-4">
                <TriangleAlert className="mx-auto" size={32} />
              </div>
              <p className="text-sm sm:text-base text-soft-gray">Falta de estrutura, repertório limitado e gestão de tempo inadequada</p>
            </LiquidGlassCard>
            <LiquidGlassCard className="p-4 sm:p-8" data-testid="card-solution">
              <h3 className="text-base sm:text-xl font-semibold text-dark-blue mb-2 sm:mb-4">Nossa Solução</h3>
              <div className="text-2xl sm:text-4xl mb-2 sm:mb-4 text-[#6b87f6]">
                <Lightbulb className="mx-auto" size={32} />
              </div>
              <p className="text-sm sm:text-base text-soft-gray">IA que vai te acompanhar e escrever junto com você todos os pontos</p>
            </LiquidGlassCard>
          </div>
        </div>
        ...
        <div className="mb-6 sm:mb-16">
          ...
          <div className="mb-4 sm:mb-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-8">
              <LiquidGlassCard className="p-3 sm:p-8 feature-card" data-testid="card-repertoire-explorer">
                <div className="flex items-center mb-3 sm:mb-4">
                  ...
                  <h4 className="text-base sm:text-xl font-semibold text-dark-blue">Explorador de Repertório</h4>
                </div>
              ...
              <LiquidGlassCard className="p-3 sm:p-8 feature-card" data-testid="card-brainstorm">
                <div className="flex items-center mb-3 sm:mb-4">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-bright-blue rounded-lg flex items-center justify-center mr-3 sm:mr-4">
          ...
          <div className="mb-4 sm:mb-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-8">
              <LiquidGlassCard className="p-3 sm:p-8 feature-card" data-testid="card-structure-creator">
                <div className="flex items-center mb-3 sm:mb-4">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-bright-blue rounded-lg flex items-center justify-center mr-3 sm:mr-4">
              ...
              <LiquidGlassCard className="p-3 sm:p-8 feature-card" data-testid="card-style-controller">
                <div className="flex items-center mb-3 sm:mb-4">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-bright-blue rounded-lg flex items-center justify-center mr-3 sm:mr-4">
                    <Sliders className="text-white" size={20} />
                  </div>
                  <h4 className="text-base sm:text-xl font-semibold text-dark-blue">Controlador de Escrita</h4>
                </div>
                <p className="text-sm sm:text-base text-soft-gray mb-3 sm:mb-4">Ferramenta interativa que permite ajustar em tempo real a formalidade, argumentação, complexidade vocabular e estilo do seu texto, com visualização imediata das mudanças.</p>
                <ul className="text-xs sm:text-sm text-soft-gray space-y-0.5 sm:space-y-1">
          ...
          <div className="mb-4 sm:mb-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-8">
              <LiquidGlassCard className="p-3 sm:p-8 feature-card" data-testid="card-exam-simulator">
                <div className="flex items-center mb-3 sm:mb-4">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-bright-blue rounded-lg flex items-center justify-center mr-3 sm:mr-4">
                    <Clock className="text-white" size={20} />
                  </div>
                  <h4 className="text-base sm:text-xl font-semibold text-dark-blue">Simulador de Prova Realista</h4>
                </div>
                <p className="text-sm sm:text-base text-soft-gray mb-3 sm:mb-4">
              ...
              <LiquidGlassCard className="p-3 sm:p-8 feature-card" data-testid="card-proposal-creator">
                <div className="flex items-center mb-3 sm:mb-4">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-bright-blue rounded-lg flex items-center justify-center mr-3 sm:mr-4">
                    <Newspaper className="text-white" size={20} />
                  </div>
                  <h4 className="text-base sm:text-xl font-semibold text-dark-blue">Explorador de Propostas</h4>
                </div>
                <p className="text-sm sm:text-base text-soft-gray mb-3 sm:mb-4">Sistema que busca por proposta de provas antigas e pode cria propostas de redação customizadas baseadas em temas atuais, seu nível de conhecimento e áreas de interesse, incluindo textos motivadores relevantes.</p>
                <ul className="text-xs sm:text-sm text-soft-gray space-y-0.5 sm:space-y-1">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-8">
              <LiquidGlassCard className="p-3 sm:p-8 feature-card" data-testid="card-progress-tracker">
                <div className="flex items-center mb-3 sm:mb-4">
                  ...
                  <h4 className="text-base sm:text-xl font-semibold text-dark-blue">Acompanhamento de Progresso</h4>
                </div>
                <p className="text-sm sm:text-base text-soft-gray mb-3 sm:mb-4">
              ...
              <LiquidGlassCard className="p-3 sm:p-8 feature-card" data-testid="card-knowledge-library">
                <div className="flex items-center mb-3 sm:mb-4">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-bright-blue rounded-lg flex items-center justify-center mr-3 sm:mr-4">
                    <BookOpen className="text-white" size={20} />
                  </div>
                  <h4 className="text-base sm:text-xl font-semibold text-dark-blue">Biblioteca pessoal</h4>
                </div>
                <p className="text-sm sm:text-base text-soft-gray mb-3 sm:mb-4">Salve de forma organize suas redações, propostas, estruturas de redação, repertórios que você desenvolve com o uso da nossa ferramenta e acesse materiais exclusivos.</p>
                <ul className="text-xs sm:text-sm text-soft-gray space-y-0.5 sm:space-y-1">
              ...
              <LiquidGlassCard className="p-3 sm:p-8 feature-card" data-testid="card-newsletter">
                <div className="flex items-center mb-3 sm:mb-4">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-bright-blue rounded-lg flex items-center justify-center mr-3 sm:mr-4">
