...
import { Search, Download, FileText, BookOpen, PenTool, Lightbulb, Clock, Target, Archive, Eye, Trash2, ArrowLeft, Newspaper, FolderOpen, MoreVertical, GraduationCap, ChevronDown, ChevronUp } from "lucide-react";
...
// Material Complementar Content (moved outside component for performance)
const materialContent = {
  estrutura: {
    title: "Guia de Estrutura Dissertativa",
    category: "Fundamental",
    readTime: "12 min de leitura",
    content: `# Guia Completo de Estrutura Dissertativa

## O que é uma Dissertação Argumentativa?

A dissertação argumentativa é um texto que apresenta um ponto de vista sobre determinado tema, defendendo-o com argumentos sólidos e convincentes. É o tipo textual exigido no ENEM e na maioria dos vestibulares brasileiros.

## Estrutura Clássica

### 1. INTRODUÇÃO (1 parágrafo)
**Função:** Apresentar o tema e a tese (opinião)
**Elementos obrigatórios:**
- **Contextualização:** Situe o tema no tempo/espaço/sociedade
- **Problematização:** Apresente o problema central
- **Tese:** Sua opinião clara sobre o tema

**Modelo de construção:**
1. Frase de contextualização
2. Problematização 
3. Apresentação da tese
4. Projeto de texto (opcional)

**Exemplo:**
"No século XXI, a tecnologia transformou radicalmente as relações sociais e profissionais. No Brasil, entretanto, a exclusão digital ainda é uma realidade para milhões de pessoas, perpetuando desigualdades históricas. Diante desse cenário, é fundamental que o Estado implemente políticas públicas efetivas para democratizar o acesso à internet, garantindo oportunidades iguais de desenvolvimento social e econômico."

### 2. DESENVOLVIMENTO (2 parágrafos)

#### Parágrafo 1: Primeiro Argumento
**Estrutura:**
- Tópico frasal (apresenta o argumento)
- Fundamentação (dados, exemplos, citações)
- Análise (explicação da relação com a tese)
- Fechamento (conecta ao próximo parágrafo)
...
- Fundamentação (dados, exemplos, citações)
- Análise (explicação da relação com a tese)
- Fechamento (conecta à conclusão)

### 3. CONCLUSÃO (1 parágrafo)
**Função:** Retomar a tese e apresentar proposta de intervenção
**Elementos obrigatórios:**
- **Retomada da tese**
- **Síntese dos argumentos**
- **Proposta de intervenção** (deve conter):
  - Agente (quem vai fazer)
  - Ação (o que vai ser feito)
  - Modo/Meio (como será feito)
  - Finalidade (para que será feito)
  - Detalhamento (quando, onde, etc.)

## Conectivos por Seção

### Introdução:
- Para contextualizar: "No contexto...", "Atualmente...", "Historicamente..."
- Para problematizar: "Entretanto...", "Contudo...", "No entanto..."
- Para apresentar tese: "Diante disso...", "Dessa forma...", "Assim..."

### Desenvolvimento:
- Para iniciar: "Primeiramente...", "Em primeira análise..."
- Para fundamentar: "Segundo...", "De acordo com...", "Conforme..."
- Para exemplificar: "Por exemplo...", "Como no caso de...", "Tal como..."
- Para concluir argumento: "Dessa maneira...", "Assim...", "Portanto..."

### Conclusão:
- Para retomar: "Portanto...", "Diante do exposto...", "Logo..."
- Para propor: "Para tanto...", "Assim...", "Dessa forma..."

## Critérios de Avaliação ENEM

1. **Domínio da modalidade escrita formal** (200 pontos)
2. **Compreensão da proposta de redação** (200 pontos)
3. **Seleção, relação, organização e interpretação de informações** (200 pontos)
4. **Demonstração de conhecimento dos mecanismos linguísticos** (200 pontos)
5. **Elaboração de proposta de intervenção** (200 pontos)

## Dicas Importantes

### O que FAZER:
- Use terceira pessoa (impessoal)
- Varie os conectivos
- Cite dados e exemplos concretos
- Mantenha coerência argumentativa
- Respeite os direitos humanos
- Faça proposta detalhada e viável

### O que NÃO fazer:
- Não use primeira pessoa
- Não fuja do tema
- Não copie textos motivadores
- Não use linguagem informal
- Não faça proposta genérica
- Não desrespeite direitos humanos

## Checklist Final

Antes de entregar sua redação, verifique:
- [ ] A introdução apresenta tese clara?
- [ ] Os argumentos estão bem fundamentados?
- [ ] Há conectivos adequados?
- [ ] A conclusão retoma a tese?
- [ ] A proposta está completa e detalhada?
- [ ] O texto respeita a norma culta?
- [ ] Não há fuga do tema?

**Lembre-se:** A prática leva à perfeição. Treine regularmente e analise redações nota 1000 para aprimorar sua técnica!`
  },
  conectivos: {
    title: "Conectivos e Coesão Textual",
    category: "Técnico",
    readTime: "8 min de leitura",
    content: `# Conectivos e Coesão Textual: Guia Completo

## O que são Conectivos?

Conectivos são palavras ou expressões que estabelecem relações lógicas entre ideias, frases, parágrafos ou partes do texto...`
  },
  repertorio: {
    title: "Como Usar Repertório Cultural",
    category: "Avançado", 
    readTime: "15 min de leitura",
    content: `# Como Usar Repertório Cultural na Redação

## O que é Repertório Cultural?

Repertório cultural são conhecimentos adquiridos ao longo da vida através de leituras, filmes, música, arte...`
  },
  intervencao: {
    title: "Proposta de Intervenção Eficaz",
    category: "ENEM",
    readTime: "10 min de leitura",
    content: `# Proposta de Intervenção Eficaz no ENEM

## O que é a Proposta de Intervenção?

A proposta de intervenção é a parte final da redação do ENEM onde você deve apresentar uma solução concreta...`
  },
  norma: {
    title: "Domínio da Norma Culta",
    category: "Gramática",
    readTime: "20 min de leitura",
    content: `# Domínio da Norma Culta: Guia Essencial

## O que é a Norma Culta?

A norma culta é a variedade linguística de maior prestígio social, utilizada em situações formais...`
  },
  analise: {
    title: "Análise de Redações Nota 1000",
    category: "Exemplos",
    readTime: "25 min de leitura", 
    content: `# Análise de Redações Nota 1000 do ENEM

## O que faz uma redação valer 1000 pontos?

Uma redação nota máxima deve atender perfeitamente aos 5 critérios de avaliação...`
  }
};
...
export default function BibliotecaPage() {
  ...
  const openMaterialModal = (materialKey: keyof typeof materialContent) => {
    ...
    if (!material) {
      console.warn(`Material não encontrado: ${materialKey}`);
      return;
    }
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 sm:px-6 py-3 sm:py-8 pt-16 sm:pt-24">
        ...
        <div className="mb-6 sm:mb-8">
          <Collapsible open={isComplementarOpen} onOpenChange={setIsComplementarOpen}>
            <CollapsibleTrigger asChild>
              <LiquidGlassCard className="p-4 sm:p-6 cursor-pointer hover:shadow-lg transition-all duration-200 bg-gradient-to-br from-green-50/80 to-green-100/50 border-green-200/50 hover:border-green-300/70" data-testid="collapsible-material-complementar">
                <div className="flex items-center justify-between">
                  ...
                  <div className="ml-4">
                    {isComplementarOpen ? (
                      <ChevronUp className="text-dark-blue" size={20} />
                    ) : (
                      <ChevronDown className="text-dark-blue" size={20} />
                    )}
                  </div>
                </div>
              </LiquidGlassCard>
          ...
          <div className="grid gap-3 sm:gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            <LiquidGlassCard className="p-4 sm:p-6 hover:shadow-lg transition-all duration-200 cursor-pointer bg-gradient-to-br from-green-50/80 to-green-100/50 border-green-200/50 hover:border-green-300/70" data-testid="material-estrutura">
              <div 
                ...
                onClick={() => openMaterialModal('estrutura')}
              >
            ...
            <LiquidGlassCard className="p-4 sm:p-6 hover:shadow-lg transition-all duration-200 cursor-pointer bg-gradient-to-br from-blue-50/80 to-blue-100/50 border-blue-200/50 hover:border-blue-300/70" data-testid="material-conectivos">
              <div 
                className="flex items-start space-x-3 sm:space-x-4"
                onClick={() => openMaterialModal('conectivos')}
              >
            ...
            <LiquidGlassCard className="p-4 sm:p-6 hover:shadow-lg transition-all duration-200 cursor-pointer bg-gradient-to-br from-purple-50/80 to-purple-100/50 border-purple-200/50 hover:border-purple-300/70" data-testid="material-repertorio">
              <div 
                className="flex items-start space-x-3 sm:space-x-4"
                onClick={() => openMaterialModal('repertorio')}
              >
            ...
            <LiquidGlassCard className="p-4 sm:p-6 hover:shadow-lg transition-all duration-200 cursor-pointer bg-gradient-to-br from-orange-50/80 to-orange-100/50 border-orange-200/50 hover:border-orange-300/70" data-testid="material-intervencao">
              <div 
                className="flex items-start space-x-3 sm:space-x-4"
                onClick={() => openMaterialModal('intervencao')}
              >
            ...
            <LiquidGlassCard className="p-4 sm:p-6 hover:shadow-lg transition-all duration-200 cursor-pointer bg-gradient-to-br from-indigo-50/80 to-indigo-100/50 border-indigo-200/50 hover:border-indigo-300/70" data-testid="material-norma">
              <div 
                className="flex items-start space-x-3 sm:space-x-4"
                onClick={() => openMaterialModal('norma')}
              >
            ...
            <LiquidGlassCard className="p-4 sm:p-6 hover:shadow-lg transition-all duration-200 cursor-pointer bg-gradient-to-br from-amber-50/80 to-amber-100/50 border-amber-200/50 hover:border-amber-300/70" data-testid="material-analise">
              <div 
                className="flex items-start space-x-3 sm:space-x-4"
                onClick={() => openMaterialModal('analise')}
              >
      ...
      {/* Modal de Material Complementar */}
      <Dialog open={showMaterialModal} onOpenChange={setShowMaterialModal}>
        <DialogContent className="max-w-4xl max-h-[90vh] flex flex-col overflow-hidden" aria-describedby="material-details-description">
          <DialogHeader>
            <div className="flex items-center space-x-3 mb-2">
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-1">
                  ...
                  <span className="text-xs text-gray-500">{selectedMaterial?.readTime}</span>
                </div>
              </div>
            </div>
          </DialogHeader>
          ...
          {selectedMaterial && (
            <div className="flex-1 min-h-0 flex flex-col overflow-hidden" id="material-details-description">
              {/* Conteúdo do Material */}
              <div className="flex-1 overflow-y-auto p-4 bg-gray-50 rounded-lg">
                <div className="prose prose-sm max-w-none">
                  {selectedMaterial.content.split('\n').map((line: string, index: number) => {
                    if (line.startsWith('# ')) {
                      return <h1 key={index} className="text-2xl font-bold text-dark-blue mb-4 mt-6 first:mt-0">{line.replace('# ', '')}</h1>
                    } else if (line.startsWith('## ')) {
                      return <h2 key={index} className="text-xl font-semibold text-dark-blue mb-3 mt-5">{line.replace('## ', '')}</h2>
                    } else if (line.startsWith('### ')) {
                      return <h3 key={index} className="text-lg font-medium text-dark-blue mb-2 mt-4">{line.replace('### ', '')}</h3>
                    } else if (line.startsWith('#### ')) {
                      return <h4 key={index} className="text-base font-medium text-dark-blue mb-2 mt-3">{line.replace('#### ', '')}</h4>
                    } else if (line.startsWith('**') && line.endsWith('**')) {
                      return <p key={index} className="font-semibold text-dark-blue mb-2">{line.replace(/\*\*/g, '')}</p>
                    } else if (line.startsWith('- ')) {
                      return <p key={index} className="ml-4 mb-1 text-soft-gray">• {line.replace('- ', '')}</p>
                    } else if (line.trim().startsWith('✅') || line.trim().startsWith('❌')) {
                      return <p key={index} className="mb-2 text-soft-gray font-medium">{line}</p>
                    } else if (line.trim() === '') {
                      return <br key={index} />
                    } else {
                      return <p key={index} className="mb-3 text-soft-gray leading-relaxed">{line}</p>
                    }
                  })}
                </div>
              </div>
              ...
              <div className="flex justify-between items-center pt-6 border-t border-gray-200 mt-4">
                ...
                <div className="flex space-x-3">
                  <Button
                    ...
                    className="text-bright-blue border-bright-blue/30 hover:bg-bright-blue/10"
                    onClick={() => {
                      const materialForPdf = {
                        id: 'material-' + Math.random(),
                        title: selectedMaterial.title,
                        type: 'Material de Estudo',
                        category: selectedMaterial.category,
                        date: new Date().toISOString(),
                        size: selectedMaterial.readTime,
                        description: `Material educativo: ${selectedMaterial.title}`,
                        content: selectedMaterial.content
                      };
                      downloadAsPDF(materialForPdf);
                    }}
